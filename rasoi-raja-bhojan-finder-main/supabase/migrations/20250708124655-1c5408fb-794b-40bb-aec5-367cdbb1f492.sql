...
ALTER TYPE public.delivery_status ADD VALUE IF NOT EXISTS 'food_preparing';
ALTER TYPE public.delivery_status ADD VALUE IF NOT EXISTS 'food_ready';
ALTER TYPE public.delivery_status ADD VALUE IF NOT EXISTS 'picked_up';
